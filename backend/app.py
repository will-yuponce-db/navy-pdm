...
def get_performance_metrics():
    ...
    # Mock data for now
    return jsonify(
        {"efficiency": 87.5, "downtime": 2.3, "readiness": 94.2, "maintenance": 78.9}
    )
    ...
    return jsonify(
        {
            ...
            "byHomeport": {"NB Norfolk": 94.2, "San Diego": 91.8, "Pearl Harbor": 89.5},
            "byShipClass": {"DDG": 93.1, "CG": 91.7, "FFG": 88.9},
        }
    )
